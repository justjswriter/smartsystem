...
def login_and_get_token(client: httpx.Client, base_url: str, *, email: str, password: str) -> str:
...
def main() -> int:
    ...
    try:
        with httpx.Client(timeout=httpx.Timeout(15.0, connect=5.0)) as client:
            ...
            token = login_and_get_token(client, base_url, email=args.email, password=args.password)
            ...
            attach_sensor(client, base_url, token=token, sensor_id=sensor_id, plant_id=plant_id)
